...
const Home = () => {
  return (
    <div className="bg-[#0a192f] text-white">
      {/* Hero Section */}
      <div className="w-full flex flex-col md:flex-row items-center justify-center text-center px-4 gap-6 relative">
        {/* Content */}
        <div className="relative flex flex-col items-center md:justify-around gap-8 mt-10 mb-8">
          {/* Profile Image */}
          <img
      ...
      <div className="w-full bg-[#0a192f] py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
          {/* Education Card */}
          <div className="bg-[#112240] p-6 rounded-lg shadow-lg hover:scale-105 transition-transform">
            <div className="flex justify-between items-center">
              <span className="text-lg font-semibold text-gray-400">
                2021 - 2025
              </span>
              <div>
                ...
                <p className="text-gray-400">B.Tech</p>
                <p className="text-gray-400">CGPA: 8.12</p>
              </div>
            </div>
          </div>
